...
class pruebaControler extends Controller
{
    public function home(){
                ...
                foreach ($dato as $dato2) {
                   ...
                   $nombre=$dato2->Nombre;
                    ...
                    // 5.2) INSERT DE TODAS LAS EXTECIONES ENCONTRADAS
                        ...
                        try {
                            DB::table('transaccion')->insert(['id_tipo' => $id, 'descripcion' =>  $nombre ]);
                        } catch (\Exception $e) {
                            DB::rollback();
                            return 'Problema al insertar los datos en la tabla transaccion' . $e;
                        }
        ...
        $datosInsertados= DB::table('transaccion')
